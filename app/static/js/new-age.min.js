...
$.getJSON("https://raw.githubusercontent.com/averyyip/capone/master/app/static/data/prediction.json", function(data) {
    ...
    const predict_amount = data.map(function(location) {
        return location.Amount
    });
    const predict_date = data.map(function(location) {
        return location.Date;
    });
    const past_amount = data.map(function(location) {
        return location.Past_Amounts;
    });
    const past_date = data.map(function(location) {
        return location.Previous_Purchases;
    });
